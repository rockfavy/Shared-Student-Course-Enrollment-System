...
public class LoginPageTests : TestContext
{
    ...
    public void LoginPage_Renders_EntraId_Message_In_Production_With_EntraId_Configured()
    {
        ...
        Assert.Contains("Sign in with Microsoft", cut.Markup);
        Assert.Contains("Redirecting to Microsoft Entra ID", cut.Markup);
    ...
    public void LoginPage_Displays_Error_Message_On_Login_Failure()
    {
        ...
        cut.WaitForState(() => cut.Markup.Contains("Invalid email or password") ||
                              cut.Markup.Contains("error", StringComparison.OrdinalIgnoreCase));

        Assert.True(cut.Markup.Contains("Invalid email or password") ||
                   cut.Markup.Contains("error", StringComparison.OrdinalIgnoreCase));
    }
    ...
    public void LoginPage_Displays_Error_Message_On_Exception()
    {
        ...
        cut.WaitForState(() => cut.Markup.Contains("error", StringComparison.OrdinalIgnoreCase));
